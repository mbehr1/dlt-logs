...
export const config: Options.Testrunner = {
    ...
    capabilities: [{
        ...
        //
        browserName: 'vscode',
        browserVersion: '1.70.2', // "insiders" or "stable" for latest VSCode version
        'wdio:vscodeOptions': {
                ...
                "dlt-logs.filters": [
                    {
                        ...
                        "ctid": "CPUS",
                        "name": "CPU load",
                        "payloadRegex": "CPU usage in interval : (?<cpu_usage>.*)% iowait: .* cpu since boot : (?<cpu_since_boot>.*)% Total thread cpu load : (?<thread_cpu_load>.*)%",
